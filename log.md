...
## [2026-05-23] debug | seo-wave2-mantra — 3-agent debug mantra verify: all 11 bugs confirmed present at current main HEAD. Root cause cluster: webpack .src relative paths + NEXT_PUBLIC_SITE_URL stale references. M5/M6 already fixed (audit older version). Ready to implement.
