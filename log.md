...
## [2026-05-25] session-end | cinematic hero header — fixed header on homepage, full-bleed hero, isCinematic prop, hero-top-gradient, icon color fix, hero image sizes 100vw, admin upload specs. 10 frontend files uncommitted. Atom extracted: nextjs-fixed-header-per-route.
