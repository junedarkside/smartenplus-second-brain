...
- **Previous audit** (`activities-day-tour-page-review.md`) addressed UX/design/code quality. Did NOT investigate location search failure specifically.
...
- [[activities-day-tour-page-review]] — UX/design/code quality audit on same page (FQ-0, UX-1 through UX-5 are separate issues)
- [[adr-experiences-nav-category-filtering]] — Category URL param filter chain (working correctly, not related to this bug)
