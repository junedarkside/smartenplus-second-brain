...
The premium desktop redesign (`experience-detail-page-redesign.md`) shipped a polished 2-column layout at `lg` (1024px). But 1024px is iPad Pro landscape — a tablet breakpoint, not desktop. This caused:
...
- [[experience-detail-page-redesign]] — desktop premium redesign (prerequisite)
