...
5-batch production-safe fix sequence from [[payment-deep-review-2026-06-12]] + [[payment-deep-review-verification-2026-06-12]]. **20 findings confirmed, 1 REFUTED (M4 → retract, subsumed by M1), 1 KB inaccuracy (M8 in [[payment-backend-charge-flow]] §5).** No code changed yet — this is the implementer playbook.

## Pre-flight (mandatory)

1. Read [[payment-deep-review-2026-06-12]] in full (HIGHs, MEDIUMs, Suggested fix order, Overturned/Corrected).
2. Read [[payment-deep-review-verification-2026-06-12]] in full (per-finding verdicts, M4 refutation detail, KB inaccuracy note).
...
### M4 — RETRACT
M4 is subsumed by M1 (both target `pendingCharge` UX surface in QR path). Update [[payment-deep-review-2026-06-12]] to add a "Retracted" section noting M4 → retracted (M1 covers it).
...
[[payment-deep-review-2026-06-12]] · [[payment-deep-review-verification-2026-06-12]] · [[omise-api-reference-2026-06-12]] · [[payment-checkout-5-principles]] · [[payment-gateway-charge-architecture]] · [[payment-finalize-deep-dive]] · [[payment-exception-catalog]] · [[payment-charge-service-layer]] · [[payment-frontend-flow-mechanics]] · [[payment-qr-polling-mechanics]] · [[refund-flow]] · [[payment-status-enums]] · [[payment-backend-charge-flow]]
