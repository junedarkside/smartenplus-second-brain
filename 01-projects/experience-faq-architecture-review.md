...
**Follow-up:** [[not-suitable-for-section]] surfaces these eligibility constraints as a dedicated operator-authored section (not buried in FAQ), adds admin multi-select, JSONField enum on Contract.
...
- [[experience-detail-ipad-mobile-redesign]] — tablet/mobile layout
