...
## Summary
File-by-file plan to add a Transportation | Experiences segmented control to the homepage search, replace the white-card hero with the existing cinematic hero, and split the over-size search form. Decision basis: [[adr-homepage-search-transportation-experiences-tabs]] (audited 2026-06-17). Frontend repo: `smartenplus-frontend`. No backend change.
...
- [[adr-experiences-nav-category-filtering]]
