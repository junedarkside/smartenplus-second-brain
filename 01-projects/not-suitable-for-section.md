...
- SmartEnPlus highest-dispute segments (wheelchair/pregnant/elderly/children) = exactly who benefits. Refund/dispute is a known pain area ([[payment-deep-review]]).
...
- **Remove duplicate `age_restriction` render in `DayTripContent.js:98-115`** in same PR (ghost component, flagged in [[experience-faq-architecture-review]]).
...
- [[experience-faq-architecture-review]] — flagged age_restriction booking-blocking + DayTripContent ghost + stale admin paths
- [[experience-detail-page-redesign]] — parent redesign
- [[payment-deep-review]] — refund/dispute pain area (business case)
