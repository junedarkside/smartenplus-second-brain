...
- [[activities-day-tour-page-review]] — UX-1 finding originally flagged dual unlabeled search as P0
- [[activities-location-search-bug]] — location search zero-results bug fix (RC-1 through RC-3)
- [[adr-experiences-nav-category-filtering]] — category URL param chain
