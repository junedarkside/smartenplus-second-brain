...
| **WA-7** | **ProductSearchForm2 mobile input height inconsistency** | OPEN. From/To labels (lines 228, 257) lack `min-h-[44px]` that Date/Return/Passenger have (lines 270, 291, 321). Mobile flex-col mode shows inconsistent row heights. Add `min-h-[44px]` to From/To for parity. ~5 min. | `components/search/ProductSearchForm2.js:228,257` |
