...
## Context
Extracted from [[transportation-category-audit]]. Goal: match Grab/Klook/12Go polish on homepage airport section. Backend adds `station_name` + `iata_code` to local serializer only.
