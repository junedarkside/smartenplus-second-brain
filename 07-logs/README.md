...
## Summary
Session-end handoffs, snapshot baselines, and wrap-up outputs.

## Contents
- [[log]] — append-only session log (current work)
...
- Each entry: `## [YYYY-MM-DD] <type> | <summary>`
- Use snapshots for diffable baselines
